...
| Theme presets and custom themes  | Yes                          | Semantic tokens, five documented contrast-checked presets, and CSS-variable overrides.                                 | Seven presets (`light`, `dark`, Material variants, Matrix, Dracula) and a small custom theme object.                 |
